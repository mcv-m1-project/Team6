...
function evalmodel(directory,trainingset,model,colorSpace)
    ...
    for i=1:size(files,1),
     ...
     sprintf('The result for model %s and space %s: [f1 = %f,pixelPrecision = %f, pixelAccuracy = %f, pixelSpecificity = %f, pixelSensitivity = %f, elapse time = %f,  TP = %d FP = %d, FN = %d] \n',model,colorSpace,F1measure,pixelPrecision, pixelAccuracy, pixelSpecificity, pixelSensitivity,timemean,pixelTP,pixelFP,pixelFN)
     fprintf(fid,'The result for model %s and space %s: [f1 = %f,pixelPrecision = %f, pixelAccuracy = %f, pixelSpecificity = %f, pixelSensitivity = %f, elapse time = %f, TP = %d FP = %d, FN = %d] \n',model,colorSpace,F1measure,pixelPrecision, pixelAccuracy, pixelSpecificity, pixelSensitivity,timemean,pixelTP,pixelFP,pixelFN);
     fclose(fid);
end
